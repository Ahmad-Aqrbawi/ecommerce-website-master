...
namespace CP.API.Migrations
{
    ...
    [Migration("20200707171522_nysql623623160.5")]
    partial class nysql6236231605
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CP.API.Model.Discount", b =>
                {
            ...
            modelBuilder.Entity("CP.API.Model.Section", b =>
                {
                    b.Property<int>("SectionId")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("CP.API.Model.Supplier", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<string>("CommercialActivities");
            ...
            modelBuilder.Entity("CP.API.Model.SupplierRole", b =>
                {
            ...
            modelBuilder.Entity("CP.API.Model.PhotoForSupplier", b =>
                {
                    b.HasOne("CP.API.Model.Supplier", "Supplier")
            ...
            modelBuilder.Entity("CP.API.Model.Product", b =>
                {
                    b.HasOne("CP.API.Model.Section", "Section")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("CP.API.Model.Supplier")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
